...
-(void)viewDidLoad
{
    ...
    if ([self.title isEqualToString:@"Line Chart"]) {
        ...
        self.lineChart.xGridLinesColor = [UIColor lightGrayColor];
...
//        self.lineChart.showSmoothLines = YES;
        ...
        // Line Chart #1
//        NSArray * data01Array = @[@0.1, @160.1, @126.4, @0.0, @186.2, @127.2, @176.2];
...
//        
        // Line Chart #2
        NSArray * data02Array = @[@30.0, @80.1, @96.4, @102.2, @126.2, @167.2, @276.2];
...
//        };
        ...
        data02.getXData = ^(NSUInteger index){
            CGFloat xValue = [xArray[index] floatValue] ;
            return [PNLineChartDataItem dataItemWithX:xValue];
        };
